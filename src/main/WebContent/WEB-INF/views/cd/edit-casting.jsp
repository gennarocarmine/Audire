...
<c:set var="pageTitle" value="Modifica Annuncio Casting" scope="request"/>
...
<main class="container mt-3 mb-3 casting-container">
    ...
    <div class="casting-card">
        ...
        <div class="casting-header">
            ...
            <h2 class="form-title">Modifica Annuncio</h2>
            <p class="form-subtitle">Aggiorna i dettagli per: <strong>${casting.title}</strong></p>
        </div>
        ...
        <form action="${pageContext.request.contextPath}/cd/edit-casting" method="post" id="castingForm">
            ...
            <div class="form-grid">
                ...
                <div class="form-group full-width">
                    ...
                    <select name="productionID" id="productionID" class="form-select" required>
                        ...
                        <c:forEach var="prod" items="${myProductions}">
                            <option value="${prod.productionID}"
                                ${casting.productionID == prod.productionID ? 'selected' : ''}>
                ...
                <div class="form-group">
                    ...
                    <select name="category" id="category" class="form-select" required>
                        <option value="Attore_Attrice" ${casting.category == 'Attore_Attrice' ? 'selected' : ''}>Attore / Attrice</option>
                        <option value="Musicista" ${casting.category == 'Musicista' ? 'selected' : ''}>Musicista</option>
                        <option value="Doppiatore_trice" ${casting.category == 'Doppiatore_trice' ? 'selected' : ''}>Doppiatore / Doppiatrice</option>
                        <option value="Ballerino" ${casting.category == 'Ballerino' ? 'selected' : ''}>Ballerino / Ballerina</option>
                        <option value="Cantante" ${casting.category == 'Cantante' ? 'selected' : ''}>Cantante</option>
                        <option value="Qualsiasi" ${casting.category == 'Qualsiasi' ? 'selected' : ''}>Altro</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="deadline" name="deadline" class="form-input" required
                           value="${casting.deadline.toLocalDate()}">
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="description" name="description" class="form-textarea" required
                              placeholder="Descrivi il ruolo...">${casting.description}</textarea>
            ...
            <div class="text-center mt-2">
                <a href="${pageContext.request.contextPath}/cd/view-castings" class="login-link">Annulla</a>
            </div>
